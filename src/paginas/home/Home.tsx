  ...
  return (
    <>
      <div className="flex flex-col justify-around ">
        ...
        <p className="py-6 text-center font-mono text-2xl bg-green-100">
          Somos uma empresa dedicada à produção e comercialização de mudas para
          ...
          futuro mais sustentável e equilibrado.
        </p>
      </div>
    </>
  );
