        ...
        <>
            <div className="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
                        ...
                        <div className=" relative ">
                            ...
                            <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    Vamos mudar o
                                    <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">mundo?</span>
                                </h2>
                                <p className="text-base text-gray-700">Bem-vindo ao nosso e-commerce dedicado à preservação do meio ambiente e à luta contra as mudanças climáticas! Aqui, na Reflorescer, estamos comprometidos com uma causa maior: contribuir ativamente para a realização da ODS-13 da ONU, que demanda medidas urgentes para combater as mudanças climáticas e seus impactos.<br /><br />
                ...
                <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
                    <svg width="800px" height="800px" viewBox="0 0 256 256" xmlns="" className="w-48 z-0  h-full -rotate-90   object-fill fill-red-300 text-red-300">
